...
export async function POST(request: Request) {
  try {
    ...
    // 👇 You can log, validate, or process custom headers and events here
    console.log('Received webhook payload:', payload);

    // 🧩 Placeholder: Add your own custom webhook handling logic below
    // For example: trigger Supabase functions, send Slack notifications, etc.

    return NextResponse.json({ message: 'Stripe removed. Webhook received.' });
  } catch (error) {
